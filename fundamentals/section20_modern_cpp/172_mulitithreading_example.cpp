...
void dotProductNaive(const std::vector<int> & v0, const std::vector<int> & v1, const unsigned i_start, const unsigned i_end, unsigned long long & sum)
{
    for(unsigned i = i_start; i < i_end; ++i)
        sum += v0[i] * v1[i];
}

void dotProductLock(const std::vector<int> & v0, const std::vector<int> & v1, const unsigned i_start, const unsigned i_end, unsigned long long & sum)
{
...
void dotProductAtomic(const std::vector<int> & v0, const std::vector<int> & v1, const unsigned i_start, const unsigned i_end, std::atomic<unsigned long long> & sum)
{
    for(unsigned i = i_start; i < i_end; ++i)
    {
        sum += v0[i] * v1[i];
...
auto dotProductFuture(const std::vector<int> & v0, const std::vector<int> & v1, const unsigned i_start, const unsigned i_end)
{
    int sum = 0;
    for(unsigned i = i_start; i < i_end; ++i)
    {
